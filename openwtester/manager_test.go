...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO ALC", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	walletID := "WEvDCw2ts4Do5kMjEfAqNneo7yMqZgz5R6"
	account := &openwallet.AssetsAccount{Alias: "mainnetALC", WalletID: walletID, Required: 1, Symbol: "ALC", IsTrust: true}
