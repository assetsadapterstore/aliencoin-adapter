...
func TestTransfer(t *testing.T) {
	...
	//AZaGHFaAhnYZWXCGeaRrpfVr3T3UEiyWfp
	//AJccKgsnpBMm3tUB2bUzRFsv6tDnzXwoTF
	//ASzs21VKVc9Hc32srDk9XPYgfYgMVJGkCB
	//AXpX1QsJQp3avWbouZrYUxEC715c46MZqx
	//AYp61ao8q5n4zEqXyTZCM4QA6Fzh59yGzu
	//Ace56p4CnXHT2cpdYspPVN8DSVEpQrsisZ

	tm := testInitWalletManager()
	walletID := "WKeGZFy4x2xQKbHuLxYmEFhZMBTgDMHKrN"
	accountID := "4rSiHcHnmGzYKCdeXbsaLT5C1czGiszpm6LSWMoZCdRb"
	to := "AK84UEYQDyW2jXJ5yGUPdXS1DSeDicWg4o"

	testGetAssetsAccountBalance(tm, walletID, accountID)

	rawTx, err := testCreateTransactionStep(tm, walletID, accountID, to, "200", "", nil)
	if err != nil {
		return
	}
...
func TestSummary(t *testing.T) {
	tm := testInitWalletManager()
	walletID := "WKeGZFy4x2xQKbHuLxYmEFhZMBTgDMHKrN"
	accountID := "8AMte4R27bs5hry1nbKdA4gWPeinBiTD2sWCdccXRjWU"
	summaryAddress := "AQhxgsCGDUq8oiWCK96RAaeDyJmQ924irK"
